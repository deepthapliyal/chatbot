...
export const Sidebar = () => {
    return (
        <>
            <div className="w-1/5 hidden md:block lg:block bg-[#1e1f20] justify-between   flex-col ">
                <div className="p-2 mb-6 text-white h-[30vh] flex flex-col justify-between ">
                    <Button variant={"ghost"} className="rounded-full hover:bg-[#2c2d2f] hover:text-white  w-14 h-14">
